<template>
    <div class="pink-banner bg-mainpink flex items-center justify-center relative h-[64px] px-5">
        <img src="../assets/images/box.svg" alt="box" class="h-12 w-12 filter-white hidden sm:block">
        <p class="pr-3 sm:px-[30px] font-primary text-16 sm:font-bold sm:text-24 text-white">{{ $t('pinkbannertitle') }}</p>
        <button type="button" class="h-12 px-4 border border-white rounded-lg uppercase font-primary text-white text-14 text-oneellipsis">
            {{ $t('pinkbannerbtn') }}
        </button>
    </div>
...
@import '../../public/utilities/variables.scss';
